            ...
            <div class="cwt__block cwt__main-header" style="display: none;">
                <div class="row">
                    <div class="col-xs-3">
                        <div class="cwt__logo">
                            <a href="index.html">
                                <img src="assets/welcome/common/img/logo.png" alt="Clean UI Admin Template + Free Ultimate Premium Bundle + Landing Pages + BEM + Angular2 Starter Kit" />
                            </a>
                        </div>
                    </div>
                    <div class="col-xs-9">
                        <nav class="nav nav-inline pull-xs-right cwt__main-menu">
                            <div class="cwt__mobile-menu">
                                <a href="javascript: void(0);" class="nav-link cwt__main-menu__link cwt__main-menu__link--active cwt__js-click__information">Teaser</a>
                                <a href="javascript: void(0);" class="nav-link cwt__main-menu__link cwt__js-click__versions">Portfolio</a>
                                <a href="javascript: void(0);" class="nav-link cwt__main-menu__link cwt__js-click__features">Features</a>
                                <a href="javascript: void(0);" class="nav-link cwt__main-menu__link cwt__js-click__features">About Us</a>
                            </div>
                            <a href="javascript: void(0);" class="nav-link btn btn-primary cwt__main-menu__link cwt__main-menu__link--button">Contact Us</a>
                        </nav>
                    </div>
                </div>
            </div>
            ...
            <div class="cwt__block cwt__gallery">
                ...
                <div class="cwt__gallery__container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <a href="javascript: void(0);" class="cwt__gallery__item">
                                <img src="assets/welcome/common/img/screens/version_1.jpg" alt="Vertical Menu (Default)" class="cwt__gallery__item__img">
                        ...
                        <div class="col-md-4">
                            <a href="javascript: void(0);" class="cwt__gallery__item">
                                <img src="assets/welcome/common/img/screens/version_2.jpg" alt="Super Clean Mode + Menu Shadow" class="cwt__gallery__item__img">
                                <div class="cwt__gallery__item__overlay"><!-- --></div>
                                <span class="btn btn-primary cwt__gallery__item__btn">Click for Live Preview</span>
                            </a>
                            <br />
                        ...
                        <div class="col-md-4">
                            <a href="javascript: void(0);" class="cwt__gallery__item">
                                <img src="assets/welcome/common/img/screens/version_10.jpg" alt="Ecommerce Version" class="cwt__gallery__item__img">
                                <div class="cwt__gallery__item__overlay"><!-- --></div>
                                <span class="btn btn-primary cwt__gallery__item__btn">Click for Live Preview</span>
                            </a>
                            <br />
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <a href="javascript: void(0);" class="cwt__gallery__item">
                                <img src="assets/welcome/common/img/screens/version_8.jpg" alt="Horizontal Menu + Boxed" class="cwt__gallery__item__img">
                                <div class="cwt__gallery__item__overlay"><!-- --></div>
                                <span class="btn btn-primary cwt__gallery__item__btn">Click for Live Preview</span>
                            </a>
                            <br />
                        ...
                        <div class="col-md-4">
                            <div class="cwt__gallery__item cwt__gallery__item__placeholder">
                                <img src="assets/welcome/common/img/screens/version_1.jpg" alt="" class="cwt__gallery__item__img cwt__gallery__item__img--hidden">
                                <div class="cwt__gallery__item__coming-soon">
                                    <div>
                                        <span>
                                            New Layouts &amp; Colors<br>Coming Soon
                                        </span>
                            ...
                            <br />
                            <span class="cwt__gallery__item__title">&nbsp;</span>
                        </div>
                        <div class="col-md-4">
                            <div class="cwt__gallery__item cwt__gallery__item__placeholder">
                                <img src="assets/welcome/common/img/screens/version_1.jpg" alt="" class="cwt__gallery__item__img cwt__gallery__item__img--hidden">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="cwt__features__item">
                                ...
                                <div class="cwt__features__descr">
                                    Dark, Light, Blue, Green, Red, Orange
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="cwt__features__item">
                                ...
                                <div class="cwt__features__descr">
                                    Well documented and isolated framework code
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="cwt__features__item">
                                ...
                                <div class="cwt__features__descr">
                                    Includes two paid licenses of premuim products
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="cwt__features__item">
                                ...
                                <div class="cwt__features__descr">
                                    Hundreds useful elements and components
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="cwt__features__item">
                                ...
                                <div class="cwt__features__descr">
                                    Starter Kit that make developer's life easier
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="cwt__block cwt__action">
                <div class="cwt__action__container">
                    <div class="cwt__action__container-inner">
                        <a href="https://themeforest.net/item/clean-ui-admin-template-react-redux-ant-design-fully-responsive-freebies/21938700?ref=mediatec_software" class="btn btn-primary cwt__action__button">
                            Buy Now $25<br /><small>Landing Included</small>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="cwt__block cwt__feedback">
                ...
                <div class="cwt__feedback__container">
                    ...
                    <p>
                        ...
                        <br />
                        Clean UI Admin Template accelerated development 3x times and reduced QA issues by 50%. It's probably saved us $30,000 on this project.
                    </p>
                    <p><strong>Highly recommended to buy!</strong></p>
                </div>
                <div class="cwt__feedback__user">
                    <div class="cwt__feedback__user__title">
                        John Allen
                        <span>
                            Buyer, Germany
                        </span>
                ...
                <div class="cwt__feedback__container">
                    ...
                    <p>I've looked at hundreds of bootstrap themes, and this one is by far the best I've come across for
                    our project. The design is modern, and not cluttered. The code is clean and easily manageable, and their customer support has been excellent.</p>
                    <p><strong>It's new, but this one is definitely a winner.</strong></p>
                </div>
                <div class="cwt__feedback__user">
                    <div class="cwt__feedback__user__title">
                        Benjamin Kouba
